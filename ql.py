...
if __name__ == '__main__':
    ...
    run_parser.add_argument('--rootfs', required=False, default="/home/user/apps/qiling/examples/rootfs/mips32_deb6", help='emulated rootfs')
    ...
    shellcode_parser.add_argument('--rootfs', required=False, default="/home/user/apps/qiling/examples/rootfs/mips32_deb6", help='emulated rootfs, that is where all the so or dll sits')
    ...
    comm_parser.add_argument('-m','--multithread', action='store_true', default=True, dest='multithread', help='Run in multithread mode')
    ...
    # ql shellcode setup
        ...
        if options.asm == True:
            ...
            ql.shellcoder, _ = assembler.asm(assembly)
            ql.mem.write(ql.os.entry_point, bytes(ql.shellcoder))
